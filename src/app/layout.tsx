...
export const metadata: Metadata = {
  title: "Nautilus Yachts - Luxury Yacht Charters",
  description: "Experience ultimate luxury with Nautilus Yachts. Premium yacht charters with professional crew, concierge service, and world-class amenities.",
  keywords: "luxury yacht charters, yacht rental, premium boats, ocean charter, sailing experience",
  metadataBase: new URL("https://nautilusyachts.com"),
  alternates: {
    canonical: "https://nautilusyachts.com"
  },
  openGraph: {
    title: "Nautilus Yachts - Luxury Yacht Charters",
    description: "Experience ultimate luxury with our exclusive fleet of world-class yachts",
    url: "https://nautilusyachts.com",
    siteName: "Nautilus Yachts",
    images: [
      {
        url: "https://images.pexels.com/photos/238367/pexels-photo-238367.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  ...
  twitter: {
    ...
    title: "Nautilus Yachts - Luxury Yacht Charters",
    description: "Experience ultimate luxury with our exclusive fleet of world-class yachts",
    images: ["https://images.pexels.com/photos/238367/pexels-photo-238367.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
